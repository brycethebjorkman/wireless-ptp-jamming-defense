...
#include "wGptpPacketSerializer.h"
...
Register_Serializer(GptpBase, wGptpPacketSerializer);
Register_Serializer(GptpFollowUp, wGptpPacketSerializer);
Register_Serializer(GptpPdelayReq, wGptpPacketSerializer);
Register_Serializer(GptpPdelayResp, wGptpPacketSerializer);
Register_Serializer(GptpPdelayRespFollowUp, wGptpPacketSerializer);
Register_Serializer(GptpSync, wGptpPacketSerializer);

clocktime_t wGptpPacketSerializer::readClock8(MemoryInputStream& stream) const
{
...
void wGptpPacketSerializer::writeClock8(MemoryOutputStream& stream, const clocktime_t& clock) const
{
    int64_t outValue;
...
clocktime_t wGptpPacketSerializer::readTimestamp(MemoryInputStream& stream) const
{
    // 10 bytes
...
void wGptpPacketSerializer::writeTimestamp(MemoryOutputStream& stream, const clocktime_t& clock) const
{
    // 10 bytes
    simtime_t t = CLOCKTIME_AS_SIMTIME(clock);
    int64_t outValue;
...
clocktime_t wGptpPacketSerializer::readScaledNS(MemoryInputStream& stream) const
{
...
void wGptpPacketSerializer::writeScaledNS(MemoryOutputStream& stream, const clocktime_t& clock) const
{
    // The ScaledNs type represents signed values of time and time interval in units of 2^–16 ns.
    // 12 bytes
    simtime_t t = CLOCKTIME_AS_SIMTIME(clock);
...
void wGptpPacketSerializer::writePortIdentity(MemoryOutputStream& stream, const PortIdentity& portIdentity) const
{
    stream.writeUint64Be(portIdentity.clockIdentity);
    stream.writeUint16Be(portIdentity.portNumber);
}

PortIdentity wGptpPacketSerializer::readPortIdentity(MemoryInputStream& stream) const
{
...
void wGptpPacketSerializer::writeGptpBase(MemoryOutputStream& stream, const GptpBase& gptpPacket) const
{
...
void wGptpPacketSerializer::readGptpBase(MemoryInputStream& stream, GptpBase& gptpPacket) const
{
...
void wGptpPacketSerializer::readGptpFollowUpPart(MemoryInputStream& stream, GptpFollowUp& gptpPacket) const
{
...
void wGptpPacketSerializer::writeGptpFollowUpPart(MemoryOutputStream& stream, const GptpFollowUp& gptpPacket) const
{
...
void wGptpPacketSerializer::readGptpPdelayReqPart(MemoryInputStream& stream, GptpPdelayReq& gptpPacket) const
{
    stream.readByteRepeatedly(0, 10);
    stream.readByteRepeatedly(0, 10);
}

void wGptpPacketSerializer::writeGptpPdelayReqPart(MemoryOutputStream& stream, const GptpPdelayReq& gptpPacket) const
{
    stream.writeByteRepeatedly(0, 10);
    stream.writeByteRepeatedly(0, 10);
}

void wGptpPacketSerializer::readGptpPdelayRespPart(MemoryInputStream& stream, GptpPdelayResp& gptpPacket) const
{
    gptpPacket.setRequestReceiptTimestamp(readTimestamp(stream));
    gptpPacket.setRequestingPortIdentity(readPortIdentity(stream));
}

void wGptpPacketSerializer::writeGptpPdelayRespPart(MemoryOutputStream& stream, const GptpPdelayResp& gptpPacket) const
{
    writeTimestamp(stream, gptpPacket.getRequestReceiptTimestamp());
    writePortIdentity(stream, gptpPacket.getRequestingPortIdentity());
}

void wGptpPacketSerializer::readGptpPdelayRespFollowUpPart(MemoryInputStream& stream, GptpPdelayRespFollowUp& gptpPacket) const
{
    gptpPacket.setResponseOriginTimestamp(readTimestamp(stream));
    gptpPacket.setRequestingPortIdentity(readPortIdentity(stream));
}

void wGptpPacketSerializer::writeGptpPdelayRespFollowUpPart(MemoryOutputStream& stream, const GptpPdelayRespFollowUp& gptpPacket) const
{
    writeTimestamp(stream, gptpPacket.getResponseOriginTimestamp());
    writePortIdentity(stream, gptpPacket.getRequestingPortIdentity());
}

void wGptpPacketSerializer::readGptpSyncPart(MemoryInputStream& stream, GptpSync& gptpPacket) const
{
...
void wGptpPacketSerializer::writeGptpSyncPart(MemoryOutputStream& stream, const GptpSync& gptpPacket) const
{
    if (gptpPacket.getFlags() & twoStepFlag)
...
void wGptpPacketSerializer::readGptpFollowUpInformationTlv(MemoryInputStream& stream, GptpFollowUpInformationTlv& tlv) const
{
...
void wGptpPacketSerializer::writeGptpFollowUpInformationTlv(MemoryOutputStream& stream, const GptpFollowUpInformationTlv& tlv) const
{
...
void wGptpPacketSerializer::serialize(MemoryOutputStream& stream, const Ptr<const Chunk>& chunk) const
{
...
const Ptr<Chunk> wGptpPacketSerializer::deserialize(MemoryInputStream& stream) const
{
