...
class wGptp : public ClockUserModuleBase, public cListener
{
    //parameters:
    ...
    int channelNumber = 0; // 0 through 12 for 2.4GHz band
    ...
    clocktime_t channelHopInterval;
    ...
    ClockEvent* hopChannelMsg = nullptr;
